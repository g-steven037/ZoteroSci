...
export type FluentMessageId =
  ...
  | 'copyRaw'
  | 'copyResult'
  | 'easyScholar-test-failed'
  | 'easyScholar-test-success'
  | 'enableConcat'
  | 'field-abstractTranslation'
  | 'field-easyScholarIF'
  | 'field-easyScholarIF5'
  | 'field-easyScholarRank'
  | 'field-easyScholarUpdatedAt'
  ...
  | 'pref-easyScholar-clear'
  | 'pref-easyScholar-enableAuto'
  | 'pref-easyScholar-secret'
  | 'pref-easyScholar-test'
  | 'pref-easyScholar-title'
