...
pref-basic-overwriteTitleTranslation =
    .label = 覆盖已有中文标题
pref-easyScholar-title = EasyScholar 期刊分区
pref-easyScholar-enableAuto =
    .label = 新增条目时自动查询期刊分区
pref-easyScholar-secret =
    .value = SecretKey
pref-easyScholar-test = 测试连接
pref-easyScholar-clear = 清除密钥
pref-easyScholar-ttl =
    .value = 缓存时长（毫秒）
easyScholar-test-success = EasyScholar 连接成功。
easyScholar-test-failed = EasyScholar 连接失败，请检查 SecretKey 和网络。
