...
pref-easyScholar-title = EasyScholar Journal Rank
pref-easyScholar-enableAuto =
    .label = Query journal rank when adding new items
pref-easyScholar-secret =
    .value = SecretKey
pref-easyScholar-test = Test Connection
pref-easyScholar-clear = Clear Key
pref-easyScholar-ttl =
    .value = Cache duration (milliseconds)
easyScholar-test-success = EasyScholar connection succeeded.
easyScholar-test-failed = EasyScholar connection failed. Check the SecretKey and network.
