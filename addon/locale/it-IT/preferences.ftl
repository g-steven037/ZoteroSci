...
pref-basic-enableAutoTitleTranslation =
    .label = Traduci automaticamente i titoli dei nuovi elementi
pref-basic-skipChineseTitle =
    .label = Salta i titoli degli elementi in cinese
pref-basic-overwriteTitleTranslation =
    .label = Sovrascrivi i titoli cinesi esistenti
